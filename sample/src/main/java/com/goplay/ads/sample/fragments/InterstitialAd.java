...
public class InterstitialAd extends BaseFragment implements AdListener {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (!isShowLocalAssets) interstitial = new GoPlayAdsInterstitial(mContext, "https://lz-houseads.firebaseapp.com/houseAds/ads.json");
        else interstitial = new GoPlayAdsInterstitial(mContext, R.raw.ad_assets);
