...
import com.goplay.ads.sample.adapter.ViewPagerAdapter;
import com.goplay.ads.sample.fragments.BaseFragment;
import com.goplay.ads.sample.fragments.DialogAd;
import com.goplay.ads.sample.fragments.InterstitialAd;
import com.goplay.ads.sample.fragments.NativeAd;
...
/*
        billingProcessor = new BillingProcessor(MainActivity.this, null, new BillingProcessor.IBillingHandler() {
                    ...
                    public void onProductPurchased(@NonNull String productId, TransactionDetails details) {
                        ...
                        new CheckoutVerifier("https://www.lazygeniouz.com/iab-verify/goplayAds/verify.php",
...
//        if (billingProcessor != null) billingProcessor.release();
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        if (item.getItemId() == R.id.git) {
            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/gpgames")));
            return true;
        }
        return true;
    }
