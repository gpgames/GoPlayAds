...
public class GoPlayAdsNative {
    ...
    public void setNativeAdView(GoPlayAdsNativeView nativeAdView) {
    ...
    private void setUp(String response) {
        ...
        try {
            ...
            for (int object = 0; object < array.length(); object++) {
                ...
                if (hideIfAppInstalled && !jsonObject.optString("app_uri").startsWith("http") &&  GoPlayAdsHelper.isAppInstalled(mContext, jsonObject.optString("app_uri")))
        ...
        if (val.size() > 0) {
            ...
            if (nativeAdView != null) {
                final GoPlayAdsNativeView view = nativeAdView;
                ...
                else throw new NullPointerException("NativeAdView is Null. Either pass GoPlayAdsNativeView or a View in setNativeAdView()");
